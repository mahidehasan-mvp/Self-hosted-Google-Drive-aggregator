...
function BackToTop() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-8 right-8 p-3 rounded-full bg-brand-accent text-white shadow-lg transition-all z-50 hover:-translate-y-1 hover:shadow-xl ${
    ...
    <div className="min-h-screen bg-dp-bg text-dp-text">
      ...
      <header className="fixed top-0 w-full z-50 border-b border-brand-border/50 bg-brand-dark/80 backdrop-blur-md">
        <nav className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium">
            ...
            <a href="https://github.com/saimon4u/Drive-Pool" target="_blank" rel="noopener noreferrer" className="text-brand-gray hover:text-white transition-colors">GitHub</a>
      ...
      <section className="relative pt-32 pb-20 px-6 grid-bg">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            ...
            <a href="https://github.com/saimon4u/Drive-Pool" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto px-8 py-4 bg-brand-surface border border-brand-border hover:border-brand-gray text-white font-bold rounded-xl transition-all flex items-center justify-center gap-2">
        ...
        <div className="max-w-5xl mx-auto rounded-3xl p-12 md:p-20 text-center border border-brand-border bg-gradient-to-b from-brand-surface to-brand-dark overflow-hidden relative">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a href="https://github.com/saimon4u/Drive-Pool" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto px-10 py-4 border border-brand-border hover:border-brand-gray text-white font-bold rounded-xl transition-all">View on GitHub</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="py-12 px-6 border-t border-brand-border/30 bg-brand-dark">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <p className="text-xs text-brand-gray">Free &amp; open source • Self-hosted Google Drive aggregator • © 2024</p>
          <div className="flex items-center gap-6">
            <a href="https://github.com/saimon4u/Drive-Pool" className="text-brand-gray hover:text-white transition-colors" target="_blank" rel="noopener noreferrer"><svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.374 0 0 5.373 0 12c0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.042-1.416-4.042-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576C20.566 21.797 24 17.3 24 12c0-6.627-5.373-12-12-12z"></path></svg></a>
          </div>
        </div>
      </footer>
      <BackToTop />
